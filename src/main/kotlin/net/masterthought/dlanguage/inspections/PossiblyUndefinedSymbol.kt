...
fun symbolIsDefinedByDefault(identifier: Identifier): Boolean {
    ...
    if (identifier.parent is IdentifierChain && identifier.parent.parent is ModuleDeclaration) {
        return true
    }
...
//                log.info("time to resolve in inspection:" + (end - start))
    ...
    override fun getGroupDisplayName(): String = DLanguageBundle.message("d.inspections.symbol.possiblyundefined.groupname")//todo create a top level dlang key
}
