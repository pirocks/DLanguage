...
public class DLanguageDeclaratorStubElementType extends DNamedStubElementType<DLanguageDeclaratorStub, DLanguageDeclarator> {
    public DLanguageDeclaratorStubElementType(String debugName) {
        super(debugName);
    }
