...
public class DLangDmdConfigToArgsConverter {
    public static List<String> getDmdParameters(DLangRunDmdConfiguration config, Module module)
    ...
    @NotNull
    private static String getOutputFileArgument(Module module, DLangRunDmdConfiguration config) {
        return "-of" + getOutputFilePath(module, config);
    }

    @NotNull
    private static String getOutputFilePath(Module module, DLangRunDmdConfiguration config) {
    ...
    private static List<String> configToParameters(DLangRunDmdConfiguration config) {
    ...
    private static void buildCompilerParameters(DLangRunDmdConfiguration config, List<String> parameters) {
        if (config.isRelease()) {
    ...
    private static void buildOutputParameters(DLangRunDmdConfiguration config, List<String> parameters) {
    ...
    private static void buildDebugParameters(DLangRunDmdConfiguration config, List<String> parameters) {
    ...
    private static List<String> getAllDLangSources(final VirtualFile sourcesRoot, final VirtualFile[] excludedRoots)
        throws NoSourcesException, ExecutionException {
        DLangVirtualFileVisitor visitor = new DLangVirtualFileVisitor(sourcesRoot, excludedRoots);
