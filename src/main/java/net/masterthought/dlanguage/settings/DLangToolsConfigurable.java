 ...
 */
public class DLangToolsConfigurable implements SearchableConfigurable {

    public static final String D_TOOLS_ID = "D Tools";
    private static final Logger LOG = Logger.getInstance(DLangToolsConfigurable.class);
    ...
    public DLangToolsConfigurable(@NotNull Project project) {
