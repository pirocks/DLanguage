...
public class DLangStaticConstructorImpl extends StubBasedPsiElementBase<DLangStaticConstructorStub> implements DLangStaticConstructor {

  public DLangStaticConstructorImpl(DLangStaticConstructorStub stub, IStubElementType type) {
    super(stub, type);
  }

  public DLangStaticConstructorImpl(ASTNode node) {
    super(node);
  }

  public DLangStaticConstructorImpl(DLangStaticConstructorStub stub, IElementType type, ASTNode node) {
