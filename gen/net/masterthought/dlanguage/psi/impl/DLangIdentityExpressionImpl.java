...
public class DLangIdentityExpressionImpl extends ASTWrapperPsiElement implements DLangIdentityExpression {

  public DLangIdentityExpressionImpl(ASTNode node) {
    super(node);
  }
