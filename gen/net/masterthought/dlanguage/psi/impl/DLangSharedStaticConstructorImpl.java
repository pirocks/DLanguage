...
public class DLangSharedStaticConstructorImpl extends StubBasedPsiElementBase<DLangSharedStaticConstructorStub> implements DLangSharedStaticConstructor {

  public DLangSharedStaticConstructorImpl(DLangSharedStaticConstructorStub stub, IStubElementType type) {
    super(stub, type);
  }

  public DLangSharedStaticConstructorImpl(ASTNode node) {
    super(node);
  }

  public DLangSharedStaticConstructorImpl(DLangSharedStaticConstructorStub stub, IElementType type, ASTNode node) {
