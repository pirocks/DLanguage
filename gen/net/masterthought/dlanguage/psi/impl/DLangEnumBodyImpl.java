...
public class DLangEnumBodyImpl extends ASTWrapperPsiElement implements DLangEnumBody {

  public DLangEnumBodyImpl(ASTNode node) {
    super(node);
  }
  ...
  public DLangEnumMembers getEnumMembers() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, DLangEnumMembers.class));
  }
