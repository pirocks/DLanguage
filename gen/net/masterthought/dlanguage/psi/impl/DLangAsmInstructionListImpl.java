...
public class DLangAsmInstructionListImpl extends ASTWrapperPsiElement implements DLangAsmInstructionList {

  public DLangAsmInstructionListImpl(ASTNode node) {
    super(node);
  }
  ...
  public DLangAsmInstruction getAsmInstruction() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, DLangAsmInstruction.class));
  }
