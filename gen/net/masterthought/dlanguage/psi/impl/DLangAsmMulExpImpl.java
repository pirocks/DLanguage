...
public class DLangAsmMulExpImpl extends ASTWrapperPsiElement implements DLangAsmMulExp {

  public DLangAsmMulExpImpl(ASTNode node) {
    super(node);
  }
  ...
  public DLangAsmBrExp getAsmBrExp() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, DLangAsmBrExp.class));
  }

  @Override
  @Nullable
  public DLangAsmMulExp getAsmMulExp() {
    return PsiTreeUtil.getChildOfType(this, DLangAsmMulExp.class);
  }
