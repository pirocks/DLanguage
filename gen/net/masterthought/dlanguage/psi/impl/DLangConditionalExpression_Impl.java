...
public class DLangConditionalExpression_Impl extends ASTWrapperPsiElement implements DLangConditionalExpression_ {

  public DLangConditionalExpression_Impl(ASTNode node) {
    super(node);
  }
