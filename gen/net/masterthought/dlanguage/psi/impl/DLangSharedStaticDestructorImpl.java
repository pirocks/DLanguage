...
public class DLangSharedStaticDestructorImpl extends StubBasedPsiElementBase<DLangSharedStaticDestructorStub> implements DLangSharedStaticDestructor {

  public DLangSharedStaticDestructorImpl(DLangSharedStaticDestructorStub stub, IStubElementType type) {
    super(stub, type);
  }

  public DLangSharedStaticDestructorImpl(ASTNode node) {
    super(node);
  }

  public DLangSharedStaticDestructorImpl(DLangSharedStaticDestructorStub stub, IElementType type, ASTNode node) {
